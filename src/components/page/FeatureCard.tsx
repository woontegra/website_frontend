  ...
  const content = (
    <div
      className={`group relative h-full overflow-hidden rounded-2xl border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl md:p-7 ${
        dark
          ? 'border-slate-700 bg-slate-800/80 hover:border-emerald-500/40'
          : 'border-slate-200 bg-white hover:border-emerald-200'
      }`}
    >
      <div
        className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${gradient} shadow-md transition-transform group-hover:scale-105`}
      >
