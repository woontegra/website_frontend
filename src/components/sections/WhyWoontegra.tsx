...
const reasons = [
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-accent-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 icon-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
