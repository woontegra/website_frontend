...
export type ServiceDetailContent = {
  ...
  scope: {
    title: string
    subtitle: string
    items: Array<{ icon: LucideIcon; title: string; description: string; gradient: string }>
  }
  process: {
    title: string
    subtitle: string
...
export const softwareDevelopmentDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.softwareHero,
...
export const webDesignDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.webDesignHero,
...
export const ecommerceDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.ecommerceHero,
...
export const saasProductDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.saasDashboard,
...
export const trademarkPatentDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.trademarkDocument,
...
export const gameDevelopmentDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.gameScene,
...
export const digitalConsultingDetail: ServiceDetailContent = {
  ...
  hero: {
    ...
    image: frontendImages.consultingDashboard,
