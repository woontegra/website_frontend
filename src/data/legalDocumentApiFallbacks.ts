...
export function fallbackLegalDocumentHtml(type: LegalDocType): string {
  return BY_TYPE[type] ?? '<div class="legal-doc"><p>Bu belge şu anda görüntülenemedi. Lütfen daha sonra tekrar deneyin veya iletişim sayfamızdan bize ulaşın.</p></div>'
}
